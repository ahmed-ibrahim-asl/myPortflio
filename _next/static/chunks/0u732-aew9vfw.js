...
CONFIG: dict[str, Any] = {
    ...
    "yolo_task": ${D(i)},
    "workflow": ${D(e.task)},
    "dataset_yaml": ${D(e.datasetYaml)},
    "source_path": ${D(e.sourcePath)},
    "model_weights": ${D(a)},
    "epochs": ${D(e.epochs)},
    "batch_size": ${D(e.batchSize)},
    "image_size": ${D(Number(e.imageSize))},
    "device": ${D(e.device)},
    "optimizer": ${D(e.optimizer)},
${"auto"===e.optimizer?"":`    "learning_rate": ${D(e.learningRate)},
`}    "validation_confidence": ${D(e.validationConfidence)},
    "prediction_confidence": ${D(e.predictionConfidence)},
    "weight_decay": ${D(e.weightDecay)},
    "momentum": ${D(e.momentum)},
    "warmup_epochs": ${D(e.warmupEpochs)},
    "freeze_layers": ${D(e.freezeLayers)},
    "iou_threshold": ${D(e.iouThreshold)},
    "deterministic": ${D(e.deterministic)},
    "patience": ${D(e.patience)},
    "workers": ${D(e.workers)},
    "seed": ${D(e.seed)},
    "project_directory": ${D(e.projectDirectory)},
    "run_name": ${D(e.runName)},
    "cache_dataset": ${D(e.cacheDataset)},
    "use_amp": ${D(e.useAmp)},
    "export_format": ${D(e.exportFormat)},
    "export_int8": ${D(e.exportInt8)},
    "output_kind": ${D(o)},
}
