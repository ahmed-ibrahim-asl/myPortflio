...
export const ML_DATA_PROFILES = freezeRecords([
  ...
  {
    id: "prompted-images",
    label: "Images with text prompts",
    dataType: "images-and-class-prompts",
  },
  {
    id: "rgb-depth-images",
    label: "RGB images for monocular depth",
    dataType: "single-camera-rgb-images",
  },
  {
    id: "semantic-mask-images",
    label: "Images with semantic masks",
    dataType: "images-and-pixel-masks",
  },
  {
