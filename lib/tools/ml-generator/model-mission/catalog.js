...
export const MODEL_MISSION_TASKS = Object.freeze([
  ...
  freezeRecord({
    ...
    examples: ["workshop PPE", "PCB components", "traffic monitoring", "warehouse counting"],
  ...
  freezeRecord({
    ...
    examples: ["surface defects", "medical regions", "part boundaries", "crop instances"],
  ...
  freezeRecord({
    ...
    order: 7,
    level: "advanced",
    title: "Detect prompted objects",
    technicalTerm: "YOLOE-26 Open-Vocabulary Detection",
    description: "Change the classes in plain language and detect them without retraining.",
    examples: ["workshop helmet", "red circuit board", "forklift", "damaged connector"],
    modality: "Images + text prompts",
    adapterId: "legacy",
    adapterTask: "open-vocabulary-detection",
    recipeId: "yoloe-open-vocabulary",
  }),
  freezeRecord({
    id: "monocular-depth",
    order: 8,
    level: "advanced",
    title: "Estimate scene depth",
    technicalTerm: "Monocular Depth Estimation",
    description: "Turn one ordinary RGB camera into a dense per-pixel distance map.",
    examples: ["robot navigation", "obstacle awareness", "3D scene layout", "AR placement"],
    modality: "Single RGB camera",
    adapterId: "legacy",
    adapterTask: "monocular-depth",
    recipeId: "yolo26-monocular-depth",
  }),
  freezeRecord({
    id: "semantic-segmentation",
    order: 9,
    level: "advanced",
    title: "Label every pixel",
    technicalTerm: "U-Net Semantic Segmentation",
    description: "Train a complete U-Net to assign one semantic class to every pixel.",
    examples: ["road scene", "surface defects", "medical tissue", "crop health"],
    modality: "Images + class masks",
    adapterId: "legacy",
    adapterTask: "semantic-segmentation",
    recipeId: "unet-semantic-segmentation",
  }),
  freezeRecord({
    id: "neural-network",
    order: 10,
...
const YOLO_STEP_FIELDS = Object.freeze({
  ...
  model: Object.freeze(["task", "modelFamily", "modelSize"]),
  train: Object.freeze([
    "environment",
    "epochs",
    "batchSize",
...
export const LEGACY_STEP_FIELDS = Object.freeze({
  ...
  "yoloe-open-vocabulary": Object.freeze({
    data: Object.freeze(["sourcePath", "classPrompts"]),
    inspect: Object.freeze([]),
    split: Object.freeze([]),
    prepare: Object.freeze(["imageSize"]),
    model: Object.freeze(["modelSize"]),
    train: Object.freeze([]),
    evaluate: Object.freeze(["confidence"]),
    generate: Object.freeze(["outputDirectory"]),
  }),
  "yolo26-monocular-depth": Object.freeze({
    data: Object.freeze(["sourceMode", "sourcePath", "cameraIndex"]),
    inspect: Object.freeze([]),
    split: Object.freeze([]),
    prepare: Object.freeze(["imageSize"]),
    model: Object.freeze(["modelSize"]),
    train: Object.freeze([]),
    evaluate: Object.freeze([]),
    generate: Object.freeze(["outputPath"]),
  }),
  "unet-semantic-segmentation": Object.freeze({
    data: Object.freeze(["datasetDirectory", "sampleImagePath"]),
    inspect: Object.freeze([]),
    split: Object.freeze(["validationFraction"]),
    prepare: Object.freeze(["imageSize"]),
    model: Object.freeze(["numClasses", "baseChannels"]),
    train: Object.freeze(["epochs", "batchSize", "learningRate", "seed"]),
    evaluate: Object.freeze([]),
    generate: Object.freeze(["checkpointPath", "predictionPath"]),
  }),
